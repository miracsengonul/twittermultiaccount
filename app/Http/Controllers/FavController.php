    ...
    public function store(Request $request)
    {
        try {
            ...
            foreach ($cocuklar as $cocuk) {
                ...
                $res = $client->post('favorites/create.json', ['query' => [
                    'id' => $adres,
                ]]);
            }
            return redirect()->to('patron/fav')->with('status', 'Fav işlemi başarılı !');
            ...
            if ($hatalar > 0) {
                return redirect()->to('patron/fav')->with('hata', $cikti->errors[0]->message);
            }
