...
class UnFavController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            foreach ($cocuklar as $cocuk) {
                ...
                $res = $client->post('favorites/destroy.json', ['query' => [
                    'id' => $adres,
                ]]);
            }
            return redirect()->to('patron/unfav')->with('status', 'Fav silme işlemi başarılı !');
            ...
            if ($hatalar > 0) {
                return redirect()->to('patron/unfav')->with('hata', $cikti->errors[0]->message);
            }
