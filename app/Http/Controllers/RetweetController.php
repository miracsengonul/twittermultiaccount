    ...
    public function store(Request $request)
    {
        try {
            ...
            foreach ($cocuklar as $cocuk) {
                ...
                $res = $client->post('statuses/retweet/' . $adres . '.json');
            }
            return redirect()->to('patron/retweet')->with('status', 'Retweet işlemi başarılı !');
            ...
            if ($hatalar > 0) {
                return redirect()->to('patron/retweet')->with('hata', $cikti->errors[0]->message);
            }
