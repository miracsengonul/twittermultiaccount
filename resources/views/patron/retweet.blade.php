            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Retweet</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">z</a></li>
                            <li class="breadcrumb-item active">Retweet</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-block little-profile text-center">
                                <img src="{{asset('icon/retweet.png')}}" alt="Twitter">
                                <p><h2 style="color: black">Retweet Edilecek Durum : </h2></p>
                                <hr>
                                <form action="" method="POST">
                                    ...
                                    <hr>
                                    <input type="submit" class="btn btn-info" value="Retweetle">
                                </form>
                            </div>
